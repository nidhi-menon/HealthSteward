...
Both exist so that "why is this deferred" or "why isn't X built yet" has a documented answer instead of living only in someone's memory. Skipping them isn't a blocker for a tiny PR, but is expected for anything that changes behavior or defers/descopes something.
