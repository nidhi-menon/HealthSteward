...
from src.api import action_items, appointments, conditions, diagnostics, doctors, documents, health_profile, medications, profile_export, settings as settings_api, visits
...
app.include_router(profile_export.router)
