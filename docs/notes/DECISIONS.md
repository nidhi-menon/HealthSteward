...
**Status:** Implemented. Free-text anonymization remains best-effort by design (as README/CONTRIBUTING already state) — this narrows the gap, it does not close it. Library evaluation pending in #92.
