...
For the *why* behind a change, see `docs/DECISIONS.md` (architectural rationale) and `docs/DEVELOPMENT_LOG.md` (narrative build history) — this file tracks *what* shipped, not the reasoning.
